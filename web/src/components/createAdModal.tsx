...
interface Game {
 ...
 export function CreateAdModal() {
    ...
    async function handdleCreateAd(event: FormEvent) {
        ...
        const data = Object.fromEntries(formData);
          ...
          try {
           ...
           await axios.post(`http://localhost:3333/games/${data.game}/ads`, {
                name: data.name,
                yearsPlayling: Number(data.yearsPlayling),
    ...
    return (
        ...
        <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25'>
          <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
            ...
            <form onSubmit={handdleCreateAd} className='mt-8 flex flex-col gap-4'>
              ...
              <div className='flex flex-col gap-2'>
                <label htmlFor='yearsPlayling'>Joga há quantos anos?</label>
                <Input name='yearsPlayling' id='yearsPlayling' type="number" placeholder='tudo bem ser ZERO' />
              </div>
